...
import com.autodoc.server.auth.filter.JwtVerificationFilter;
import com.autodoc.server.auth.handler.MemberAuthenticationFailureHandler;
import com.autodoc.server.auth.handler.MemberAuthenticationSuccessHandler;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws  Exception {
        http.headers().frameOptions().sameOrigin()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers(HttpMethod.GET, "/members/me").hasAnyRole("USER", "ADMIN")  // (4) 추가
